...
def hydjobs_view(request):
    ...
    return render(request,'testapp/hydjobsinfo.html',my_dict)
...
def bngjobs_view(request):
    ...
    my_dict = {'jobs_list':jobs_list}
    return render(request,'testapp/bngjobsinfo.html',my_dict)

from testapp.models import PuneJobs
def punejobs_view(request):
    jobs_list = PuneJobs.objects.all()
    my_dict = {'jobs_list':jobs_list}
    return render(request,'testapp/punejobsinfo.html',my_dict)
